...
#define SL_TOPBOX_YSTART YRES/3 + BUFFER_BTW_BUTTONS
#define SL_TOPBOC_YEND 2*YRES/3
#define SL_UPPERBOX_YSTART BUFFER_BTW_BUTTONS
#define SL_UPPERBOX_YEND YRES/3
#define SL_UPPERBOX_XSTART XRES/4
#define SL_UPPERBOX_XEND 3*XRES/4
